...
expName = 'motor seq3'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bttnc\\Documents\\psy310\\motor sequence learning\\motor seq3_lastrun.py',
