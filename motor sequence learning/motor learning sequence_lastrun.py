...
expName = 'motor learning sequence'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bttnc\\Documents\\psy310\\motor sequence learning\\motor learning sequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        for thisTrial_2 in trials_2:
            ...
            _key_resp_2_allKeys = []
            # keep track of which components have finished
            trial_2Components = [fixation_2, line1_2, line2_2, line3_2, line4_2, probe_2, key_resp_2]
            ...
            while continueRoutine:
                ...
                if key_resp_2.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_2.getKeys(keyList=['null'], ignoreKeys=["escape"], waitRelease=False)
